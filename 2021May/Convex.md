...
### Аннотация: 
Любому многочлену от нескольких переменных можно сопоставить многогранник Ньютона: выпуклую оболочку показателей ненулевых мономов. Оказывается многие свойства полиномов и задаваемых ими многообразий можно описать при помощи этих многогранников. Это интересно как и само по себе, так и часто встречается в применениях.

Темы 1-4 связаны и в них перемежаются сюжеты из геометрии многогранников (1 ,4А) и их алгебро-геометрические интерпретации (2, 3,4Б). Точнее, тема 2 связана с задачей о числ корней (в торе <img src="https://render.githubusercontent.com/render/math?math=(C\setminus 0)^n">) типичной системы из n полиномов от n переменных с заданными многоугольниками Ньютона. Доказательство этой теоремы и её обобщений удобно интерпретировать на языке торических многообразий (тема 3). Тема 4 посвящена дискриминантам (поверхности пространстве коэффициентов полиномов которая соответствуют сингулярным многообразия), здесь мы следуем классической книге Гельфанда-Капранова-Зелевинского. , в частности мы покажем, что многогранник Ньютона дискриминанта является вторичными многогранником.
