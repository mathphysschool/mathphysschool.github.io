...
### Основные даты:
-  **К 22 марта** необходимо определиться с выбором тем докладов (и, по возможности, с конкретными номерами докладов внутри тем) и заполнить [форму](https://docs.google.com/forms/d/e/1FAIpQLSeWiFNjXzHdGDQeBaggz5_15n4-BHzRfSWbX4BDKfNlEWIQEw/viewform?usp=dialog)
-  **К 24 марта** организаторы проведут распределение зарегистрировавшихся участников по докладам (чтобы не получилось такого, что все будут готовить один и тот же доклад)
...
- [__Турбуленция.__](./Turbulence.md)
- [__Твисторы и ADHM конструкция.__](./Twistors.md)
- [__Дифференциалы Штребеля и комбинаторное доказательство гипотезы Виттена.__](./Witten.md)
