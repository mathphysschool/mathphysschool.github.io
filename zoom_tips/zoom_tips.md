...
Это делается в этом меню[:](#i77)

  ![](./accounts2.png)

  Чтобы не переключать аккаунты, у фаерфокса есть [дополнение](https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/) для разделения аккаунтов между вкладками[.](#i77)
...
- Здесь же можно создать новый плейлист. При создании выбираются параметры доступа:
  ...
  **Важно.** Если положить видео, доступное только по ссылке (*unlisted*/*незарегистрированное*), в плейлист с открытым доступом, его будет видно всем.
  Потому видео с доступом по ссылку должны лежать в плейлистах с доступом по ссылке.
  
- Управлять созданными плейлистами можно во вкладке *Плейлисты*, которая находится под *Видео*.
