...
![](./settings1.png) ![](./settings2.png)
  ...
  Может ничего этого нажимать не нужно будет, оно сразу отправит на страницу настроек. Главное это увидеть список опций на картинках выше[.](#i00)
...
Иначе во время конференции показывать экран сможет только организатор или соорганизатор[.](#i11)
...
Кнопку *Record to the Cloud*/*Запись в облако* может нажать как организатор, так и соорганизатор, но независимо от этого она сохраняется в облако создателя встречи.
У кого какие права во время встречи, неважно[.](#i46)
...
- <a name="i49"></a>Выкладываются видео вот этой кнопкой (не забудьте [выбрать правильный аккаунт](#i77))[:](#i49)
...
- <a name="i55"></a>Трансляцию можно запустить только из зума на компьютере (upd: с айпада уже тоже можно).
...
- <a name="i58"></a>Для того, чтобы сменить аккаунт, надо нажать *Not me*/*Не я*.
...
Попробуйте поэкспериментировать: если с вашим каналом проблем не будет, может быть лучше транслировать на него[.](#i67)
  ...
  **Важно.** Когда будете в первый раз экспериментировать со своим каналом, проверьте, что стрим живёт достаточное время.
